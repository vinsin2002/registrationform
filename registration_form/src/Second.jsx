    ...
    <div>
        ...
        <form action="" className='flex flex-col justify-center items-center mt-10'>
            <div className='flex flex-col justify-center items-center md:text-lg '>
                <div className=''>
                    <h1 className='mb-2 flex'>Provide services for <p className='text-red-500 '>*</p> </h1>
                    ...
                    <div className="form-control">
                        <label className=" label cursor-pointer  flex justify-between items-center">
                            <span className="label-text">Two-Wheeler</span> 
                            <input type="radio" name="radio-10" className="radio checked:bg-proj" checked />
                        </label>
                    </div>
                    <div className="form-control">
                        <label className="label cursor-pointer  flex justify-between items-center">
                            <span className="label-text">Four-Wheeler</span> 
                            <input type="radio" name="radio-10" className="radio checked:bg-proj" checked />
                        </label>
                    </div>
                    </div>
                    <h1 className='mt-2 mb-2 flex'>Services you Provide <p className='text-red-500 '>*</p> </h1>
                    <h1 className='text-center w-64 border-proj border mb-2 text-proj p-1'>Select</h1>
                    <div className='border p-2 rounded-lg w-64'>
                    <div className="form-control">
                        <label className="label cursor-pointer  flex justify-between items-center">
                            <span className="label-text">Servicing</span> 
                    ...
                    <div className="form-control">
                        <label className="label cursor-pointer  flex justify-between items-center">
                            <span className="label-text">Engine work</span> 
                            <input type="checkbox" name="radio-10" className="radio rounded checked:bg-proj" checked />
                        </label>
                    </div>
                    <div className="form-control">
                        <label className="label cursor-pointer  flex justify-between items-center">
                            <span className="label-text">Spark plug</span> 
                            <input type="checkbox" name="radio-10" className="radio rounded checked:bg-proj" checked />
                        </label>
                    </div>
                    </div>
...
<h1>Previous Step</h1>
                ...
                <a href='/third' className='text-white text-xl  flex justify-center items-center space-x-1'><h1>Next Step</h1> <svg width="31" height="16" viewBox="0 0 31 16" fill="none" xmlns="http://www.w3.org/2000/svg">
